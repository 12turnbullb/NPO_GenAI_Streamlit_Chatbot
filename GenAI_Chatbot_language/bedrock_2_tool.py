...
class AWSGenAITool(Tool):
    ...
    def __call__(self, query, translation_language):
        ...
        # if the bot is multilingual, detect the language in the prompt and reflect the answer as the same language
        if translation_language:
            print("translating\n")
            translation_prompt = generated_text 
            try:
                translated_text = call_jurassic(translation_prompt)
